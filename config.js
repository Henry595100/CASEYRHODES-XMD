...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Caseyrhodes~KgBGgIJY#UhVUodiHRyfEmfVu6tv3rcycQX7nIgF0IMEiehz4fNM",
// add your Session Id 
...
ANTI_DEL_PATH: process.env.ANTI_DEL_PATH || "tlue", 
// change it to 'same' if you want to resend deleted message in same chat     
WELCOME: process.env.WELCOME || "true",
// true if want welcome and goodbye msg in groups    
ADMIN_EVENTS: process.env.ADMIN_EVENTS || "tlue",
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "254791877587",
